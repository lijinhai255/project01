...
// 引入渲染库
var DealApp = (0, _store.dealFn)(_App2.default);
// 渲染
...
var _rmcFeedback = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TouchFeedback__ = __webpack_require__(112);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(41), __webpack_require__(169)(module)))
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dealFn", function() { return dealFn; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_redux__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_redux__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_redux_thunk__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reducer__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reducer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__reducer__);
// 引入createStore
...
// 合并成一句话
let store = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* applyMiddleware */])(__WEBPACK_IMPORTED_MODULE_2_redux_thunk__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0_redux__["c" /* createStore */])(__WEBPACK_IMPORTED_MODULE_3__reducer___default.a);
...
// 高阶方法
let dealFn = Object(__WEBPACK_IMPORTED_MODULE_1_react_redux__["connect"])(mapStateToProps, mapDispatchToProps);
...
function reducer() {
	...
	var result = {};
	// 判断消息类型
	if (action.type === _consts.UPDATE_USERNAME) {
		// 更新用户名
...
var _wingBlank = __webpack_require__(195);
...
var _inputItem = __webpack_require__(197);
...
var Login = function (_Component) {
	...
	_createClass(Login, [{
		key: 'onChange',
		value: function onChange(key, method, value) {
			// 解构数据
			...
			data[key] = value;
			// 存储校验结果
			errors[key] = method(value);
			// 更新状态
			this.setState({ data: data, errors: errors });
			// 校验
		}
		// 检测错误
		// checkError(key, method, value) {
		...
		value: function submitData() {
			...
			if ((0, _validator.notEmpty)(data)) {
				// 不合法
				return _toast2.default.info('请输入数据');
			}
			// 校验是否合法
			if ((0, _validator.invalid)(errors)) {
				// 不合法
				return _toast2.default.info('输入的信息不合法');
			}
			// 发送登录异步消息
			this.props.dispatch((0, _action.login)(data));
		}
		// 渲染
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					_inputItem2.default,
					{
						...
						value: data.username,
						onChange: this.onChange.bind(this, 'username', _validator.checkUsername),
						onErrorClick: function onErrorClick(e) {
							return _toast2.default.info('用户名是4到8位的');
						}
					},
					'\u7528\u6237\u540D'
				),
				...
				_react2.default.createElement(
					_inputItem2.default,
					{
						...
						value: data.password,
						type: 'password',
						onChange: this.onChange.bind(this, 'password', _validator.checkPassword),
						onErrorClick: function onErrorClick(e) {
							return _toast2.default.info('密码要求包含字母和数字');
						}
					},
					'\u5BC6\u2003\u7801'
				),
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_button2.default,
						{ type: 'primary', onTouchEnd: function onTouchEnd(e) {
...
var _getLocale = __webpack_require__(203);

var _CustomInput = __webpack_require__(204);
...
var _CustomKeyboard = __webpack_require__(206);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectWithoutProperties__ = __webpack_require__(228);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types__ = __webpack_require__(198);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_rc_animate__ = __webpack_require__(229);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_rc_util_es_createChainedFunction__ = __webpack_require__(240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_classnames__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Notice__ = __webpack_require__(241);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_prop_types__ = __webpack_require__(198);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ChildrenUtils__ = __webpack_require__(230);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__AnimateChild__ = __webpack_require__(231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__CSSMotion__ = __webpack_require__(235);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__util_animate__ = __webpack_require__(224);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_prop_types__ = __webpack_require__(198);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_css_animation__ = __webpack_require__(232);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__util_animate__ = __webpack_require__(224);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Event__ = __webpack_require__(233);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_component_classes__ = __webpack_require__(234);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_react_dom__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types__ = __webpack_require__(198);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_react_lifecycles_compat__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_classnames__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_raf__ = __webpack_require__(237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_raf___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_raf__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__util_motion__ = __webpack_require__(239);
...
exports.login = exports.updateUsername = undefined;
...
// 消息
// 引入类型
var updateUsername = exports.updateUsername = function updateUsername(data) {
	return { data: data, type: _consts.UPDATE_USERNAME };
};
